        ...
        <el-form ref="formRef" :model="form" class="login-form" :rules="rules">
            ...
            <el-form-item prop="password">
              <el-icon :size="20" class="svg-container"><Lock /></el-icon>
                ...
                <el-icon :size="20" class="show-pwd" @click="changeType">
            ...
            <el-button type="primary" class="login-button" @click="handleLogin">用户登陆</el-button>
        </el-form>
    </div>
</template>
...
const store = useStore()//登录的时候使用store里面的app的action
const form = ref({
    username: 'dingzhen',
    password: 'abc123456'
})
